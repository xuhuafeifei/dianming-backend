...
public enum ErrorCode {
    ...
    PASSWORD_ERROR,
    FILE_UPLOAD_ERROR(412030, "文件上传异常, 请联系管理员"),
    SIGN_FORIGN_KEY_ERROR(412031, "签到失败: 学生学号错误, 或学期课程id错误"),
    GET_IMAGE_PATH_FAILED(412032, "获取签到界面访问路径异常"),
    IMAGE_GENERATE_FAILED(412033, "二维码获取失败"),
    SIGN_UP_ERROR(412034, "签到失败"),
    REPEAT_SIGN_UP(412035, "重复签到");
