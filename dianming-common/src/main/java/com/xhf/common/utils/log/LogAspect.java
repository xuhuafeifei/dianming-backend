package com.xhf.common.utils.log;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.xhf.common.utils.HttpContextUtils;
import com.xhf.common.utils.IPUtils;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.xhf.common.utils.log.LogAnnotation)")
    public void pt(){
    }
    ...
    private MutablePair<LogAnnotation.MethodType, String> recordBefore(ProceedingJoinPoint joinPoint) {
        ...
        String body = null;
        try {
            body = mapper.writeValueAsString(argsList);
        } catch (JsonProcessingException e) {
            log.error("argsList con not convert to json: {}", argsList);
        }
    ...
    private void recordAfter(long time, MutablePair<LogAnnotation.MethodType, String> res, Object result) {
        ...
        if (methodType == LogAnnotation.MethodType.CONTROLLER) {
            try {
                ...
                log.error("result can not convert to json: {}", result);
            }
            log.info("=====================log end================================");
        }else {
